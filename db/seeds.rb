...
blueberry_pancakes_ingredients.each{|i| blueberry_pancakes.ingredients.build(ingredient_name: i)}
...
bacon_pancakes_ingredients.each{|i| bacon_pancakes.ingredients.build(ingredient_name: i)}
bacon_pancakes.save
